...
begin
   ...
   begin
      ...
      begin
         T := Train_CART_Variant (X, Y);
         Check ("7.1 Failed to raise Exception", False);
   ...
   begin
      ...
      begin
         T := Train_ID3_Variant (X, Y);
         Check ("8.1 Failed to raise Exception", False);
   ...
   begin
      ...
      begin
         L := Predict (T, (1 => 1.0));
         Check ("9.1 Failed to raise Exception", False);
   ...
   begin
      ...
      begin
         ...
         Check ("15.1 Failed to catch feature offset", False);
